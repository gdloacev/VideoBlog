            ...
            <div>
                ...
                <table id="Thread">
                    <tr>
                        ...
                        <td>
                       	  <input type="text" name="tbTitle" id="tbTitle" value="<?php echo 'Hola';//$row['Title']; ?>" />
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                       	  <textarea rows="8" cols="30" name="tbMessage" id="tbMessage"><?php echo echo 'Hola';//$row['Message']; ?></textarea>
                        </td>
                    </tr>
